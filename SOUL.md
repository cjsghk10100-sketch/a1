...
## Personal Output Rule

When summarizing pasted tweets/posts, use this fixed shape:
1) Conclusion (1-7 lines, depending on content density)
2) Why it matters (key reason in natural language)
