...
// Kernel minor changes in PR-11 (system health drilldown v0.1) keep SCHEMA_VERSION pinned to 2.1.
// Kernel minor changes in PR-12B (finance usage event + projector) keep SCHEMA_VERSION pinned to 2.1.
